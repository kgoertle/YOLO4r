...
def initialize_classes(force_reload=False):
    ...
    detected_classes = load_data_yaml()
    ...
    save_config()
    print(f"[INIT] FOCUS_CLASSES initialized with {len(FOCUS_CLASSES)} classes from data.yaml.")
